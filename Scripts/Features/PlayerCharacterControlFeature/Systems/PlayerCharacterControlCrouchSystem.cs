...
public class PlayerCharacterControlCrouchSystem : IEcsRunSystem
{
    [Inject] private EcsWorld _world;
    [Inject] private EcsPool<InputButtonPressedEvent> _inputButtonPressedPool;
    [Inject] private EcsPool<CharacterControlCrouchEvent> _characterControlCrouchEventPool;
    ...
    public void Run(IEcsSystems systems)
    {
        ...
        {
            if (_inputButtonPressedPool.Get(inputEventEntity).Action != InputAction.Crouch)
            {
                continue;
            }
            ...
            {
                _characterControlCrouchEventPool.Set(characterEntity);
            }
        }
    }
}